...
// 5.1 - Другий варіант - масив масивів:
let temperature2 = [
    ['Понеділок', '10ºC', '20ºC', '15ºC'],
    ['Вівторок', '9ºC', '18ºC', '15ºC'],
    ['Середа', '12ºC', '23ºC', '16ºC'],
    ['Четвер', '11ºC', '19ºC', '14ºC'],
    ['П\'ятниця', '8ºC', '16ºC', '13ºC'],
    ['Субота', '7ºC', '17ºC', '12ºC'],
    ['Неділя', '9ºC', '18ºC', '14ºC']
];
